...
import orderRoutes from "./src/router/disease/order/order.route";
...
import stockRoutes from "./src/router/disease/order/stock.route";
import vnpayRoutes from "./src/router/vnpay.route";
import cartRoutes from "./src/router/disease/order/cart.route";
